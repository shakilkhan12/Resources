<div class="sidebar">
           <ul>
               <li><?php echo anchor_void("javascript:void(0)", "<span class='profile'><img src='". Base_URL ."/assets/images/2.jpg' class='profile-img'></span>"); ?></li>
               <li><?php echo anchor_void("javascript:void(0)", '<span class="icon">&#9775;</span> Shakil Khan'); ?></li>
